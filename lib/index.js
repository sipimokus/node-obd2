...
(function (OBD2) {
    var Main = (function (_super) {
        ...
        function Main(options) {
            ...
            _this.DTC = new DTC();
            _this.PID = new PID();
            _this.OBD = new OBD(_this.PID.getListPID());
            _this.Ticker = new Ticker(_this._options.delay);
            _this.Device = new Device(_this._options.device);
            _this.Serial = new Serial(_this._options.serial, _this._options.port, {
        ...
        Main.prototype._tickListPID = function (pidList, callBack) {
            ...
            console.log("CMD2");
            setTimeout(function () {
                _this.sendPID(cmdPid, "01", function (mess, data) {
                    console.log("CMD3");
